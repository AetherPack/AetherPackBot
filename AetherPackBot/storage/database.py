...
class DatabaseManager:
    ...
    def __init__(self, db_url: str | None = None) -> None:
        if db_url:
            ...
            from AetherPackBot.kernel.paths import get_db_url
    ...
    async def get_recent_conversations(self, limit: int = 50) -> list[ConversationModel]:
        """Get recent conversations ordered by updated_at descending."""
